...
public sealed class WebSocketTransportTests
{
    ...
    public async Task WebSocket_WhenStartSessionRequested_ReturnsSessionHandle()
    {
        ...
        var startMessage = new TerminalIpcMessage
        {
            ...
            Payload = JsonSerializer.SerializeToElement(startPayload, AureTTYJsonSerializerContext.Default.TerminalIpcStartRequest)
        };
        ...
        var handle = response.Payload?.Deserialize(AureTTYJsonSerializerContext.Default.TerminalSessionHandle);
    ...
    public async Task WebSocket_WhenEventIsPublished_ReceivesEventMessage()
    {
        ...
        var sessionEvent = eventMessage.Payload?.Deserialize(AureTTYJsonSerializerContext.Default.TerminalIpcSessionEvent);
